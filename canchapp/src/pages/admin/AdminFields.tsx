  ...
  return (
    <div className="p-5 sm:p-8 space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-[var(--color-text)]">Canchas</h1>
          <p className="text-sm text-[var(--color-text-3)] mt-1">
            Visualiza y gestiona las canchas de tus complejos.
          </p>
        </div>
      ...
      <div className="bg-[var(--color-surface)] border-[1.5px] border-[var(--color-border)] rounded-[var(--radius-2xl)] p-10 flex flex-col items-center gap-4 text-center">
        ...
        <div>
          <p className="font-extrabold text-[var(--color-text)] text-lg">Gestión de canchas</p>
          <p className="text-sm text-[var(--color-text-3)] mt-1 max-w-sm">
            Lista de canchas activas e inactivas. Esta sección se completará con la integración del backend.
          </p>
        </div>
      </div>
    </div>
